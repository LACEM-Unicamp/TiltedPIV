%Uncertainty of TKE obtained from tilted PIV measurements considering
%(a) pseudo-isotropic approximation and 
%(b) axial and combined-radial components (k_2C)
%for different blade angles
%--------------------------------------------------------------------------
...
for i = 1:length(met)
    ...
    for j = 1:length(angle)          
        nexttile
        [var_e,var_x,var_y] = Reader_uncertainty_tke(impeller, angle{j}, tec, cam, pass, met{i});    
