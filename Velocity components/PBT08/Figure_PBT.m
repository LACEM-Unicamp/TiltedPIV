%(a) Radial, (b) axial and (c) out-of-plane time-averaged velocity components
%obtained from Stereo-PIV measurements at different blade angles of PBT.
%--------------------------------------------------------------------------
...
for i = 1:length(angle)
    for j = 1:length(component)
        nexttile
        [var_e,var_x,var_y] = Reader_velocity_components(impeller,angle{i},tec,cam,pass,component{j});
