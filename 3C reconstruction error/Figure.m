%3C reconstruction error of Stereo-PIV measurements 
%for different blade angles of (a) Rushton turbine and (b) PBT.
%--------------------------------------------------------------------------
...
for i = 1:length(impeller)
    ...
    for j = 1:length(angle)          
        nexttile
        [var_e,var_x,var_y] = Reader_3C_reconstruction_error (impeller{i}, angle{j}, tec, cam, pass, met);    
...
Save(save_tif, save_svg, tec, met, '')